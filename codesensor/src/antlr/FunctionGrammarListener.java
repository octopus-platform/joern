...
public interface FunctionGrammarListener extends ParseTreeListener {
	...
	void enterBlock_closer(FunctionGrammarParser.Block_closerContext ctx);
	void exitBlock_closer(FunctionGrammarParser.Block_closerContext ctx);
	...
	void enterCv_qualifier(FunctionGrammarParser.Cv_qualifierContext ctx);
	void exitCv_qualifier(FunctionGrammarParser.Cv_qualifierContext ctx);
	...
	void enterBlock_opener(FunctionGrammarParser.Block_openerContext ctx);
	void exitBlock_opener(FunctionGrammarParser.Block_openerContext ctx);
