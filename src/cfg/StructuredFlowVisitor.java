...
public class StructuredFlowVisitor extends ASTNodeVisitor
{
	...
	public void visit(ContinueStatement expression)
	{
		...
		{
			System.err
					.println("Warning: no surrounding loop found for continue-statement");
			return;
		}
	...
	public void visit(BreakStatement expression)
	{
		...
		{
			System.err
					.println("Warning: no surrounding block found for break-statement");
			return;
		}
	...
	private CFGNode addConditionBlock(BlockStarter node, CFG cfg,
			CFGNode container)
	{
