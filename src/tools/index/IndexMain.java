...
/**
 * Main Class for the indexer:
 * This class parses command line arguments and configures the indexer
 * in accordance and then uses a SourceFileWalker to to visit each source-files
 * and directories and report them to the indexer.
 * */
